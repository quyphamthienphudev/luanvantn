...
<body>
    ...
    <div @class(['container', 'mt-4'])>
        <h1 @class(['text-2xl', 'font-bold', 'mb-6'])>Chọn nhân viên để tra cứu</h1>
        <form action="/hcns/employees/detail" method="post" @class(['bg-white', 'p-6', 'rounded', 'shadow', 'w-1/2'])>
            ...
            <button name="detail" @class(['bg-green-600', 'text-white', 'px-4', 'py-2', 'rounded', 'hover:bg-green-700']) title="Tra cứu">Tra cứu</button>
        </form>
        <br>
        <h1 @class(['text-2xl', 'font-bold', 'mb-6'])>Danh sách chấm công chi tiết</h1>
        ...
        <br>
        <h1 @class(['text-2xl', 'font-bold', 'mb-6'])>Danh sách khen thưởng</h1>
        <div @class(['bg-white', 'shadow', 'rounded', 'mt-6'])>
            <table @class(['w-full', 'text-left'])>
                <thead @class(['bg-gray-200'])>
                    <tr>
        ...
        <br>
        <h1 @class(['text-2xl', 'font-bold', 'mb-6'])>Danh sách kỷ luật</h1>
        <div @class(['bg-white', 'shadow', 'rounded', 'mt-6'])>
            <table @class(['w-full', 'text-left'])>
                <thead @class(['bg-gray-200'])>
                    <tr>
