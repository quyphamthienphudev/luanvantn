            ...
            @foreach($employees as $e)
                <tr class="border-b">
                    ...
                    <td class="p-3 space-x-2">
                        <a href="/hcns/employees/show/{{ $e->id }}" class="bg-blue-500 text-white px-3 py-1 rounded">Xem</a>
                        <a href="/hcns/employees/edit/{{ $e->id }}" class="bg-yellow-500 text-white px-3 py-1 rounded">Sửa</a>
