        ...
        <table @class(['w-full', 'text-left'])>
            ...
            <tbody>
                ...
                <tr @class(['border-b'])>
                    ...
                    <td @class(['p-3'])>
                        <div @class(['flex', 'space-x-2'])>
                            <a href="/hcns/departments/edit/{{ $d->id }}" @class(['bg-yellow-500', 'text-white', 'px-3', 'py-1', 'rounded']) title="Sửa">Sửa</a>
                            <form action="/hcns/departments/delete/{{ $d->id }}" method="post">
                            @csrf 
                                <button @class(['bg-red-600', 'text-white', 'px-3', 'py-1', 'rounded']) onclick="return confirm('Bạn có muốn xoá phòng ban này ?')" title="Xoá">Xoá</button>
                            </form>
                        </div>
                    </td>
                </tr>
