                ...
                <tr class="hover:bg-gray-50 border-b">
                    ...
                    <td class="p-3 text-center">
                        <div class="flex space-x-2">
                            <a href="/hcns/attendances/edit/{{ $atd->id }}" class="text-yellow-600 hover:underline">Sửa</a>
                            <a href="/hcns/attendances/delete/{{ $atd->id }}" class="text-red-500 hover:underline" onclick="return confirm('Bạn có muốn xóa bảng chấm công này?')">Xóa</a>
                        </div>
                    </td>
                </tr>
                @endforeach
