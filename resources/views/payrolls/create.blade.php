...
<div class="max-w-2xl mx-auto bg-white rounded-lg shadow p-6">
    ...
    <form action="{{ Auth::user()->role->name === 'admin' ? route('admin.payrolls.store') : route('user.payrolls.store') }}" method="POST">
        @csrf
        ...
        <div class="flex gap-2 justify-end">
            <a href="{{ Auth::user()->role->name === 'admin' ? route('admin.payrolls.index') : route('user.payrolls.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded">Hủy</a>
