            ...
            <div @class(['card', 'shadow-sm', 'border-0'])>
                ...
                <div @class(['card-body', 'p-4'])>
                    <form action="/leave/store" method="post">
                        ...
                        <div @class(['mb-3'])>
                            <label @class(['form-label', 'fw-bold', 'small', 'text-secondary'])>Lý do xin nghỉ phép</label>
                            @error('reason')
                            <p @class(['text-red-500', 'text-sm'])>{{ $message }}</p>
                            @enderror
                        ...
                        <div @class(['d-grid', 'mt-4'])>
                            <button @class(['btn', 'btn-primary', 'shadow']) title="Gửi đơn">Gửi đơn</button>
                        </div>
                    </form>
                </div>
            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td @class(['text-center', 'pe-4'])>
                                        ...
                                        @else
                                        <span @class(['text-muted', 'small', 'fw-italic'])>
                                            <i @class(['fas', 'fa-lock'])></i> Đã hoàn tất
                                        </span>
                                        @endif
                                    </td>
                                </tr>
