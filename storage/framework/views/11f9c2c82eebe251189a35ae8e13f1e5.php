...
unset($__errorArgs, $__bag); ?>
        <div class="mb-4">
            ...
            <input type="text" name="title" value="<?php echo e($rewards->title); ?>" class="w-full border p-2 rounded" placeholder="Nội dung khen thưởng">
        </div>
        <div class="mb-4">
            <label>Số tiền</label>
            <input type="text" name="amount" value="<?php echo e($rewards->amount); ?>" class="w-full border p-2 rounded" placeholder="Số tiền">
        </div>
        <div class="mb-4">
            <label>Ngày ra quyết định</label>
            <input type="date" name="decision_date" value="<?php echo e($rewards->decision_date); ?>" class="w-full border p-2 rounded">
        </div>
