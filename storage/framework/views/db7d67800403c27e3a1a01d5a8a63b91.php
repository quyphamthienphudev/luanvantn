...
<body>
    ...
    <form method="POST" action="/hcns/candidates/update/<?php echo e($candidates->id); ?>" class="bg-white p-6 w-1/2">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        <div class="mb-4">
            ...
            <input type="text" name="candidate_id" value="<?php echo e($candidates->candidate_id); ?>"
        ...
        <div class="mb-4">
            ...
            <input type="date" name="date_of_birth" value="<?php echo e($candidates->date_of_birth); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/hcns/candidates/edit.blade.php ENDPATH**/ ?>