...
<body>
    <a href="/departments/create" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Thêm phòng ban</a>
            ...
            <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="border-b">
                    ...
                    <td class="p-3 space-x-2">
                        <a href="/departments/edit/<?php echo e($d->id); ?>" class="bg-yellow-500 text-white px-3 py-1 rounded">Sửa</a>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/user/departments/index.blade.php ENDPATH**/ ?>