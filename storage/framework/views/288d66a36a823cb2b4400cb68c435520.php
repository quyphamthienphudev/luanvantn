...
<body>
    ...
    <form method="POST" action="/candidates/update/<?php echo e($candidates->id); ?>" class="bg-white p-6 w-1/2">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/user/candidates/edit.blade.php ENDPATH**/ ?>