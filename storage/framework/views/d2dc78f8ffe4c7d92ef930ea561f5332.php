...
<form action="/leave/update/<?php echo e($leave->id); ?>" method="POST" class="bg-white p-6 rounded shadow w-1/2">
    ...
    <div class="row">
        <div class="col-md-6 mb-4">
            ...
            <input type="text" name="" class="form-control shadow-sm bg-gray-100" value="<?php echo e($leave->user->name); ?>" readonly>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\PROJECT-2026\resources\views/user/leave/edit.blade.php ENDPATH**/ ?>