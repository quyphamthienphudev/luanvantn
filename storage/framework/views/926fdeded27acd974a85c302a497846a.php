            ...
            <tbody>
                ...
                <tr class="border-b">
                    ...
                    <td class="p-3 space-x-2">
                        <a href="/hcns/candidates/show/<?php echo e($c->id); ?>"
                            class="bg-blue-500 text-white px-3 py-1 rounded" title="Xem">Xem</a>
                        <a href="/hcns/candidates/edit/<?php echo e($c->id); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\PROJECT-2026\resources\views/hcns/candidates/index.blade.php ENDPATH**/ ?>