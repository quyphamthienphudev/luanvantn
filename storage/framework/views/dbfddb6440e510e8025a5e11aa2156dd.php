...
<body>
    <a href="/qlcl/attendances" class="btn btn-secondary">
        ← Quay lại
    </a>
        ...
        <form action="/qlcl/attendances/update/<?php echo e($attendance->id); ?>" method="POST">
            ...
            <div class="grid grid-cols-2 gap-6">
                <div class="mb-4">
                    ...
                    <input type="text" name="" value="<?php echo e($attendance->user->name); ?>"
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="work_date" value="<?php echo e($attendance->work_date); ?>"
                        class="w-full border rounded p-2 outline-none bg-gray-100" readonly>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/qlcl/attendances/edit.blade.php ENDPATH**/ ?>