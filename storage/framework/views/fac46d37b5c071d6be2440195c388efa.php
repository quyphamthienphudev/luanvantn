    ...
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow p-6">
        ...
        <form action="/hcns/payrolls" method="post">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="allowance" class="w-full border p-2 rounded" value="<?php echo e(old('allowance')); ?>" placeholder="Phụ cấp">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <select name="year" class="w-full border rounded px-3 py-2">
                        <?php for($i = 2001; $i <= 2099; $i++): ?> <option value="<?php echo e($i); ?>" <?php echo e($year == $i ? 'selected' : ''); ?>>Năm
                            <?php echo e($i); ?></option>
                        <?php endfor; ?>
                    </select>
                </div>
            ...
            <div class="flex gap-2 justify-end">
                ...
                <button class="bg-blue-500 text-white px-4 py-2 rounded" title="Lưu">Lưu</button>
            </div>
        </form>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\PROJECT-2026\resources\views/hcns/payrolls/create.blade.php ENDPATH**/ ?>