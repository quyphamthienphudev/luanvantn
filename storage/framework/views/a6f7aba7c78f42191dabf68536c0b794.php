    ...
    <div class="bg-white shadow rounded mt-6">
        <table class="w-full text-left">
            ...
            <tbody>
                ...
                <tr class="border-b">
                    <td class="p-3"><?php echo e($r->name); ?></td>
                    <td class="p-3"><?php echo e($r->description); ?></td>
                    <td class="p-3 space-x-2">
                        <a href="/httt/roles/edit/<?php echo e($r->id); ?>" class="bg-yellow-500 text-white px-3 py-1 rounded" title="Sửa">
                            Sửa
                        </a>
                        <a href="/httt/roles/delete/<?php echo e($r->id); ?>" class="bg-red-600 text-white px-3 py-1 rounded"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\PROJECT-2026\resources\views/httt/roles/index.blade.php ENDPATH**/ ?>