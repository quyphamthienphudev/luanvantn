                ...
                <td class="text-center">
                    <div class="d-flex justify-content-center align-items-center gap-2 action-group ">
                        ...
                        <button class="btn btn-info btn-sm btn-action text-white" title="Chỉnh sửa">
                            <a href="/hcns/leave/edit/<?php echo e($leave->id); ?>"><i class="fas fa-edit"></i></a>
                        </button>
                        
                        <button class="btn btn-danger btn-sm btn-action" title="Xoá">
                            <a href="/hcns/leave/delete/<?php echo e($leave->id); ?>" onclick="return confirm('Bạn có muốn xóa đơn xin nghỉ phép này?')">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\PROJECT-2026\resources\views/hcns/leave/index.blade.php ENDPATH**/ ?>