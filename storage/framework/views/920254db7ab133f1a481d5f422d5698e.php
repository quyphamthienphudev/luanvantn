        ...
        <table class="w-full text-left">
            ...
            <tbody>
                ...
                <tr class="border-b">
                    ...
                    <td class="p-3">
                        <?php if($e->status == 'working'): ?>
                        Đang làm việc
                        <?php endif; ?>
                        <?php if($e->status == 'resigned'): ?>
                        Đã nghỉ việc
                        <?php endif; ?>
                    </td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\PROJECT-2026\resources\views/hcns/employees/index.blade.php ENDPATH**/ ?>