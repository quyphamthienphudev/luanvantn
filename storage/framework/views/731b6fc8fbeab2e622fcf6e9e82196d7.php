            ...
            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="border-b">
                    ...
                    <td class="p-3 space-x-2">
                        <a href="/hcns/employees/show/<?php echo e($e->id); ?>" class="bg-blue-500 text-white px-3 py-1 rounded">Xem</a>
                        <a href="/hcns/employees/edit/<?php echo e($e->id); ?>" class="bg-yellow-500 text-white px-3 py-1 rounded">Sửa</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/hcns/employees/index.blade.php ENDPATH**/ ?>