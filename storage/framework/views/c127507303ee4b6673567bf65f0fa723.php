...
<body>
    ...
    <form method="POST" action="/hcns/disciplines/store" class="bg-white p-6 rounded shadow w-1/2">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="title" class="w-full border p-2 rounded" placeholder="Nội dung kỷ luật" value="<?php echo e(old('title')); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\PROJECT-2026\resources\views/hcns/disciplines/create.blade.php ENDPATH**/ ?>