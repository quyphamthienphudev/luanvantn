...
unset($__errorArgs, $__bag); ?>
        <div class="mb-4">
            ...
            <input type="text" name="" value="<?php echo e($disciplines->employee->full_name); ?>" class="w-full border p-2 rounded bg-gray-100" readonly>
        </div>
        <div class="mb-4">
            <label>Mã nhân viên</label>
            <input type="text" name="" value="<?php echo e($disciplines->employee->employee_code); ?>" class="w-full border p-2 rounded bg-gray-100" readonly>
        </div>
        <div class="mb-4">
