        ...
        <script>
            ...
            const leaveChart = new Chart(ctxLeave, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: <?php echo json_encode($leaveData); ?>,
                        borderWidth: 1,
                        backgroundColor: [
                            '#ffc107', // chờ duyệt
                            '#28a745', // đã duyệt
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/user/dashboard.blade.php ENDPATH**/ ?>