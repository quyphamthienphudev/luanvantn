            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <select name="year" class="w-full border rounded px-3 py-2">
                        <?php for($i = 2020; $i <= 2099; $i++): ?> <option value="<?php echo e($i); ?>" <?php echo e($year == $i ? 'selected' : ''); ?>>Năm <?php echo e($i); ?></option>
                            <?php endfor; ?>
                    </select>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/hcns/payrolls/create.blade.php ENDPATH**/ ?>