    ...
    <div class="max-w-2xl mx-auto bg-white rounded-lg shadow p-6">
        ...
        <table class="w-full">
            <tr class="border-b">
                ...
                <td class="py-2"><?php echo e($payroll->employee_code); ?></td>
            </tr>
            <tr class="border-b">
                <th class="text-left py-2">Họ tên</th>
                <td class="py-2"><?php echo e($payroll->full_name); ?></td>
            </tr>
            <tr class="border-b">
                <th class="text-left py-2">Phòng ban</th>
                <td class="py-2"><?php echo e($payroll->department_name); ?></td>
            </tr>
            <tr class="border-b">
                <th class="text-left py-2">Chức vụ</th>
                <td class="py-2"><?php echo e($payroll->position_name); ?></td>
            </tr>
            <tr class="border-b">
            ...
            <tr class="border-b">
                ...
                <td class="py-2"><?php echo e(number_format($payroll->allowance ?? 0)); ?> VNĐ</td>
            </tr>
            <tr class="border-b">
            ...
            <tr class="border-b">
                ...
                <td class="py-2"><?php echo e(number_format($payroll->work_numbers ?? 0)); ?> ngày</td>
            </tr>
            <tr class="border-b">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\PROJECT-2026\resources\views/user/payrolls/show.blade.php ENDPATH**/ ?>