...
unset($__errorArgs, $__bag); ?>" 
                                      rows="4" cols="50"><?php echo e(old('reason')); ?></textarea>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="ps-4" width="25%">
                                        <div class="fw-bold"><?php echo e(\Carbon\Carbon::parse($leave->start_date)->format('d/m/Y')); ?></div>
                                        <div class="text-muted small">đến <?php echo e(\Carbon\Carbon::parse($leave->end_date)->format('d/m/Y')); ?></div>
                                    </td>
                                    <td width="40%">
                                        <div class="fw-bold text-primary"><?php echo e($leave->employee->full_name ?? 'N/A'); ?></div>
                                    ...
                                    <td class="text-center pe-4" width="50%">
                                        <?php if($leave->status == 'pending'): ?>
                                            <a href="/leave/edit/<?php echo e($leave->id); ?>" class="btn btn-sm btn-outline-primary px-3">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/user/leave/index.blade.php ENDPATH**/ ?>