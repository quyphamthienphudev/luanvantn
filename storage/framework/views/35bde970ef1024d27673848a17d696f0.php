            ...
            <table class="min-w-full bg-white border">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2"><?php echo e($p->employee_code); ?></td>
                        <td class="border px-4 py-2"><?php echo e($p->full_name); ?></td>
                        <td class="border px-4 py-2"><?php echo e($p->department_name); ?></td>
                        <td class="border px-4 py-2"><?php echo e($p->position_name); ?></td>
                        ...
                        <td class="border px-4 py-2 text-center">
                            <a href="/hcns/payrolls/<?php echo e($p->id); ?>" class="text-blue-500 hover:underline" title="Xem">Xem</a>
                            <a href="/hcns/payrolls/edit/<?php echo e($p->id); ?>" class="text-yellow-500 hover:underline" title="Sửa">Sửa</a>
                            <a href="/hcns/payrolls/delete/<?php echo e($p->id); ?>" class="text-red-500 hover:underline" onclick="return confirm('Bạn có muốn xóa bảng lương này ?')" title="Xoá">Xoá</a>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\PROJECT-2026\resources\views/hcns/payrolls/index.blade.php ENDPATH**/ ?>