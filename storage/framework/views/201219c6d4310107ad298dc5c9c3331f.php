        ...
        <table class="w-full text-left">
            ...
            <tbody>
                ...
                <tr class="border-b">
                    ...
                    <td class="p-3"><?php echo e(number_format($p->base_salary)); ?> VNĐ</td>
                    <td class="p-3"><?php echo e(number_format($p->max_salary)); ?> VNĐ</td>
                    <td class="p-3 space-x-2">
                        <a href="/hcns/positions/edit/<?php echo e($p->id); ?>"
                            class="bg-yellow-500 text-white px-3 py-1 rounded" title="Sửa">
                            Sửa
                        </a>
                        <a href="/hcns/positions/delete/<?php echo e($p->id); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\PROJECT-2026\resources\views/hcns/positions/index.blade.php ENDPATH**/ ?>