        ...
        <tbody>
            ...
            <tr class="border-b">
                ...
                <td class="ps-3">
                    ...
                    <div class="small text-muted">đến <?php echo e(\Carbon\Carbon::parse($leave->end_date)->format('d/m/Y')); ?>
                ...
                <td class="text-center">
                    <div class="d-flex justify-content-center align-items-center gap-2 action-group ">
                        ...
                        <a href="/qlcl/leave/edit/<?php echo e($leave->id); ?>" class="btn btn-info btn-sm btn-action text-white"
                            title="Chỉnh sửa">
                            <i class="fas fa-edit"></i>
                        </a>
                        <?php endif; ?>

                        <form action="/qlcl/leave/delete/<?php echo e($leave->id); ?>" method="POST" class="m-0 p-0"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/qlcl/leave/index.blade.php ENDPATH**/ ?>