            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50 border-b">
                    <td class="p-3">
                        ...
                        <!-- <p class="text-xs text-gray-500">Mã nhân viên: <?php echo e($atd->employee?->employee_code); ?></p> -->
                    </td>
                    ...
                    <td class="p-3 text-center">
                        <div class="flex space-x-2">
                            <a href="/hcns/attendances/edit/<?php echo e($atd->id); ?>" class="text-yellow-600 hover:underline">Sửa</a>
                            <a href="/hcns/attendances/delete/<?php echo e($atd->id); ?>" class="text-red-500 hover:underline" onclick="return confirm('Bạn có muốn xóa bảng chấm công này?')">Xóa</a>
                        </div>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/hcns/attendances/index.blade.php ENDPATH**/ ?>