...
<body>
    ...
    <form method="POST" action="/hcns/candidates/update/<?php echo e($candidates->id); ?>" class="bg-white p-6 w-1/2">
        ...
        <div class="mb-4">
            ...
            <input type="text" value="<?php echo e($candidates->candidate_id); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\PROJECT-2026\resources\views/hcns/candidates/edit.blade.php ENDPATH**/ ?>