...
<body>
    ...
    <form action="/admin/leave/update/<?php echo e($leave->id); ?>" method="POST"
    class="bg-white p-6 rounded shadow w-1/2">
        ...
        <div class="row">
            <div class="col-md-6 mb-4">
                ...
                value="<?php echo e($leave->user->id ?? $leave->employee->employee_code); ?>" readonly>
            </div>              
        </div>
        <div class="row">
            <div class="col-md-6 mb-4">
                ...
                value="<?php echo e($leave->start_date); ?>" required>
            </div>        
            <div class="col-md-6 mb-4">
                <label class="form-label fw-bold small text-uppercase">
                    Ngày kết thúc
                ...
                value="<?php echo e($leave->end_date); ?>" required>
            </div>              
        </div>
        <div class="row">
            <div class="col-md-6 mb-4">
            ...
            <br>
            <textarea name="reason" class="form-control shadow-sm" rows="4" cols="50" required><?php echo e($leave->reason); ?></textarea>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/admin/leave/edit.blade.php ENDPATH**/ ?>