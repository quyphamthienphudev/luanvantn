...
<body>
    ...
    <?php echo csrf_field(); ?>
    <h4>Tìm kiếm</h4>
    <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Tìm theo id hoặc theo tên">
    <select name="sort">
...
</html><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/users/index.blade.php ENDPATH**/ ?>