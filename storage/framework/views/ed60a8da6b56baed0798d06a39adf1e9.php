...
<body>
    ...
    <div class="mb-6 flex justify-between items-center">
        ...
        <div class="flex gap-2">
            <a href="/admin/payrolls/export?month=<?php echo e($month); ?>&year=<?php echo e($year); ?>" class="bg-yellow-500 text-white px-4 py-2 rounded">Xuất file Excel</a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/admin/payrolls/index.blade.php ENDPATH**/ ?>