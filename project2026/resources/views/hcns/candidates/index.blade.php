            ...
            @foreach($candidates as $c)
                <tr class="border-b">
                    ...
                    <td class="p-3 space-x-2">
                        <a href="/hcns/candidates/show/{{ $c->id }}" class="bg-blue-500 text-white px-3 py-1 rounded">Xem</a>
                        <a href="/hcns/candidates/edit/{{ $c->id }}" class="bg-yellow-500 text-white px-3 py-1 rounded">Sửa</a>
