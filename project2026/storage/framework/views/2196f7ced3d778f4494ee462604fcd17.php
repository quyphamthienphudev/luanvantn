    ...
    <form method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="email"
                   ...
                   class="w-full px-4 py-2 border rounded" placeholder="Email">
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/user/profile.blade.php ENDPATH**/ ?>