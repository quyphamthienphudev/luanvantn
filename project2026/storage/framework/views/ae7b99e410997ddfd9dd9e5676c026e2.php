...
<body>
    ...
    <form method="GET" action="/admin/accounts" class="mt-4">
        Tìm kiếm: <input type="text" name="search" value="<?php echo e($search); ?>" class="border p-2" placeholder="Tìm theo họ tên, email, quyền hoặc trạng thái" style="width:400px;">
            ...
            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="border-b">
                    ...
                    <td class="p-3 space-x-2">
                        <a href="/admin/accounts/edit/<?php echo e($user->id); ?>"
                        class="bg-yellow-500 text-white px-3 py-1 rounded">
                            Sửa
                        </a>
                        <a href="/admin/accounts/delete/<?php echo e($user->id); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/admin/accounts/index.blade.php ENDPATH**/ ?>