...
<body>
    ...
    <?php endif; ?>
    <form action="/admin/payrolls/update/<?php echo e($payroll->id); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="mb-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/admin/payrolls/edit.blade.php ENDPATH**/ ?>