...
<body>
    ...
    <form method="POST" action="/admin/employees/store" class="bg-white p-6 rounded shadow w-1/2">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/admin/employees/create.blade.php ENDPATH**/ ?>