...
<div class="max-w-4xl mx-auto mt-10 bg-white p-8 rounded-lg shadow">
    ...
    <form action="/admin/attendances/update/<?php echo e($attendance->id); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\quy\Desktop\project2026\resources\views/admin/attendances/edit.blade.php ENDPATH**/ ?>